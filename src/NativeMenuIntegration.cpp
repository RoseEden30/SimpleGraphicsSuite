...
namespace NativeMenuIntegration
{
    namespace
    {
        ...
        float __stdcall GetHighlightGlow() { return ActiveSettings()->postProcessing.highlightGlow; }
        void  __stdcall SetHighlightGlow(float a_value)
        {
            EditableSettings().postProcessing.highlightGlow = a_value;
            PublishSettings();
            RequestSaveSettings();
        }
